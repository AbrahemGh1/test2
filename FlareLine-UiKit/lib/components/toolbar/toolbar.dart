...
import '../forms/search_box_widget.dart';
      ...
      child: Container(
        ...
        child: Row(children: [
            ...
            child: Stack(
              ...
              children: [
                Container(
                    ...
                    child: SvgPicture.asset('assets/crm/notification.svg',
                        width: 20, height: 20)),
                const Align(
                  child: AnimBadge(),
                )
              ...
              children: [
                Container(
                    ...
                    decoration: const BoxDecoration(
                        color: FlarelineColors.background,
                        shape: BoxShape.circle),
                    child: SvgPicture.asset('assets/crm/message.svg',
                        width: 20, height: 20)),
                const Align(
                  child: AnimBadge(),
                ),
          ...
          InkWell(
            ...
            onTap: () async {
              print("profile pic top corner taped");
              await showMenu(
                color: Colors.white,
                context: context,
